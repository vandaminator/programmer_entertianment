...
function clearAll(item) {
  const memeContainer = document.querySelector('.image-meme');
...
function showMeme() {
  ...
  const container = document.querySelector('.image-meme')
  container.appendChild(randomMeme);
...
function showJoke() {
  ...
  randomJoke.innerHTML = randomJokeText;
  const container = document.querySelector('.joke')
  container.appendChild(randomJoke);
}
...
function showQuote() {
  ...
  clearAll('.quote');
  const randomQouteText = document.createElement('p');
  const randomQouteAuthor = document.createElement('p');
  randomQouteText.innerHTML = randomQuote.quote;
  randomQouteAuthor.innerHTML = '- ' + randomQuote.author;
  const container = document.querySelector('.quote')
  container.appendChild(randomQouteText);
  container.appendChild(randomQouteAuthor);
}
